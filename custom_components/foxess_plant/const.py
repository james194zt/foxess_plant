...
PANEL_ENTITY_SUFFIXES: dict[str, tuple[str, ...]] = {
    ...
    "bms_design_energy_wh": ("bms_design_energy_wh", "bms_kwh_nominal"),
...
DEFAULT_SMART_CHARGE = {
    ...
    "operating_mode": "max_safety",
    "agile_poll_interval_minutes": 15,
    "negative_import_interrupt": True,
    "price_drop_interrupt_p_per_kwh": 2.0,
    "daily_plan_time": "16:00",
    "daily_plan_horizon_hours": 24,
    "house_load_kw_fallback": 1.0,
    "dark_hours_estimate": 8.0,
    "outage_reserve_load_kw": None,
    "outage_reserve_hours": 3.0,
